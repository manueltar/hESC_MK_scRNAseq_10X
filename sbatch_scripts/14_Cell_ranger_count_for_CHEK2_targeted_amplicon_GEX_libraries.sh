...
path_for_10X_transcriptome_reference=$(echo "/group/soranzo/manuel.tardaguila/2025_hESC_MK_multiome/GEX_reseq/alignment/GFP_transgene_vCHEK2_and_DNMT3A_cellranger")
