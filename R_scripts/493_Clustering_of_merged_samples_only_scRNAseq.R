...
merge_and_recall_peaks = function(option_list)
{
  ...
  # Clustering - FindNeighbors and FindClusters (using default method which is Louvain or similar)
  adata2 <- FindNeighbors(adata2, dims = 1:50)
  adata2 <- FindClusters(adata2, algorithm=4, resolution = 2, verbose=FALSE, method = "igraph")
